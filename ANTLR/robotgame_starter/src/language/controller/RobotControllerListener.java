...
public interface RobotControllerListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link RobotControllerParser#direction}.
	 * @param ctx the parse tree
	 */
	void enterDirection(RobotControllerParser.DirectionContext ctx);
	/**
	 * Exit a parse tree produced by {@link RobotControllerParser#direction}.
	 * @param ctx the parse tree
	 */
	void exitDirection(RobotControllerParser.DirectionContext ctx);
	/**
